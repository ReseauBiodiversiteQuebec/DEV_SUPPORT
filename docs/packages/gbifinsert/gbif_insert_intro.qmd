...
[Repo Github](https://github.com/ReseauBiodiversiteQuebec/gbif_insert)
...
### New installation
```bash
pip3 install git+https://github.com/ReseauBiodiversiteQuebec/gbif_insert#egg=gbif_insert
